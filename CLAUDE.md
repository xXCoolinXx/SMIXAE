...
- [x] Verify FVE calculation correctness. Changed to `1 - mean(‖x−x̂‖²) / var(x)` (standard mean-centred form; previous uncentered denominator was inflated by the residual stream DC mean).
